...
const sections = [
    {
        bgImage: "/assets/images/full-width-images/home-banner-1.jpg",
    ...
    {
        bgImage: "/assets/images/full-width-images/home-banner-2.jpg",
        // title: "Resonance Creative Studio",
        // subtitle: "Grow your business with new online experience.",
        // status: "Based in London, United Kingdom",
    },
    {
        bgImage: "/assets/images/full-width-images/home-banner-3.jpg",
        // title: "Resonance Creative Studio",
                    ...
                    <SwiperSlide className='owl-item' key={index}>
                        ...
                        >
                            <div className='container min-height-100vh d-flex align-items-center pt-100 pb-100 pt-sm-120 pb-sm-120'>
                                ...
                                <div className='home-content'>
                                    <div className='row'>
                                        ...
                                        {/* <div className='col-md-10 offset-md-1 mb-20 mb-sm-0'>
                                            <h2 className='hs-title-11 mb-30 mb-xs-10 owl-animate-fadeInUp'>{elm.title}</h2>
                                            <h1 className='hs-title-12 mb-50 mb-sm-30'>
                                                <span className='owl-animate-chars' data-splitting='chars'>
                                ...
                                {/* Scroll Down */}
                                <div className='local-scroll scroll-down-wrap-4 d-none d-sm-block wow fadeInUp' data-wow-offset={0}>
                                ...
                                {/* End Scroll Down */}
                                {/* Status */}
                                <div className='hs-status d-none d-sm-block wow fadeInUp' data-wow-offset={0}>
                                    {elm.status}
                                </div>
                                {/* End Status */}
                            </div>
